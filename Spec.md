...
Сервер расположен по адресу https://21.objects.htmlacademy.pro/cinemaddict.

Спецификация по взаимодействию с сервером в формате OpenAPI — https://21.objects.htmlacademy.pro/spec/cinemaddict.
